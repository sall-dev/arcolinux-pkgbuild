...
echo
echo "#############################################################################################"
echo "Give the pkgversion number like 20.1"
echo "#############################################################################################"
...
list="arco-calamares-config arcod-calamares-config arcob-calamares-config-xfce
arcob-calamares-config-openbox arcob-calamares-config-i3"
